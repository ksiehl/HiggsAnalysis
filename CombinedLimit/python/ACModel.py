...
class ACModel3DShape(AnomalousCouplingModel):
    def __init__(self,mode):
        AnomalousCouplingModel.__init__(self)
        self.processes = ['anoCoupl']
        self.channels  = ['process']
...
par1par2par3_TH3_shape_Model = ACModel3DShape('par1par2par3_TH3')
par1par2par3_TF3_shape_Model = ACModel3DShape('par1par2par3_TF3')
#par1par2par3_TH3_shape_Model = ACModel3DShape2('par1par2par3_TH3')
#par1par2par3_TF3_shape_Model = ACModel3DShape2('par1par2par3_TF3')
